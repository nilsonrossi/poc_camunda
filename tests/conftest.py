...
# WARNING: Ensure imports from `poc_camunda` comes after this line
from poc_camunda import app, settings, db  # noqa
from poc_camunda.cli import create_user, cli  # noqa
